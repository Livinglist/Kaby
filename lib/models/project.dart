...
class Project {
  ...
  Project.create({this.name}) : uid = Uuid().v1();
  ...
  Map<String, dynamic> toMap() => {idKey: id, uidKey: uid, projectNameKey: name, projectTasksKey: jsonEncode(tasks.map((t) => jsonEncode(t.toMap())).toList())};
