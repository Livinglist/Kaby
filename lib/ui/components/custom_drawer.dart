...
/// Signature for the callback that's called when a [CustomDrawerController] is
/// opened or closed.
...
/// State for a [CustomDrawerController].
///
...
class CustomDrawerControllerState extends State<CustomDrawerController> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    controller = AnimationController(duration: _kBaseSettleDuration, vsync: this)
  ...
  void _move(DragUpdateDetails details) {
    ...
    final bool opened = controller.value > 0.5;
